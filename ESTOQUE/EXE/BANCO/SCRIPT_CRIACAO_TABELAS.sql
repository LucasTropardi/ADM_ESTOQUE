...
ALTER TABLE PRODUTO
ALTER DESCRICAO TO PRODUTO_DESCRICAO;

/* CRIA TABELA DE FORMA DE PAGAMENTO*/
...
CREATE TABLE COMPRA(
    ...
    CONSTRAINT FK_FORNECEDOR_COMPRA FOREIGN KEY(ID_FORNECEDOR)
    REFERENCES FORNECEDOR(ID_FORNECEDOR),
    CONSTRAINT FK_FORMA_PGTO FOREIGN KEY(ID_FORMA_PGTO)
    REFERENCES FORMA_PGTO(ID_FORMA_PGTO)            
);

/* CRIA TABELA DE ITENS DE COMPRA */
CREATE TABLE ITEM_COMPRA(
    ...
    CONSTRAINT FK_COMPRA_ITEM_COMPRA FOREIGN KEY(ID_COMPRA)
    REFERENCES COMPRA(ID_COMPRA),
    CONSTRAINT FK_PRODUTO_ITEM_COMPRA FOREIGN KEY(ID_PRODUTO)
...
CREATE TABLE CONTAS_PAGAR(
    ...
    CONSTRAINT FK_COMPRA_CONTAS_PAGAR FOREIGN KEY(ID_COMPRA)
...
CREATE TABLE VENDA(
    ...
    CONSTRAINT FK_FORMA_PGTO_VENDA FOREIGN KEY(ID_FORMA_PGTO)
    REFERENCES FORMA_PGTO(ID_FORMA_PGTO)            
);

/* CRIA TABELA DE ITENS DE VENDA */
CREATE TABLE ITEM_VENDA(
    ...
    CONSTRAINT FK_PRODUTO_ITEM_VENDA FOREIGN KEY(ID_PRODUTO)
    REFERENCES PRODUTO(ID_PRODUTO) ON DELETE CASCADE    
);
...
CREATE TABLE CONTAS_RECEBER(
    ...
    CONSTRAINT FK_VENDA_CONTAS_RECEBER FOREIGN KEY(ID_VENDA)
    REFERENCES VENDA(ID_VENDA) ON DELETE CASCADE            
);

/* Alterando a tabela EMPRESA */
ALTER TABLE EMPRESA
ADD CEP VARCHAR(14) NOT NULL;
