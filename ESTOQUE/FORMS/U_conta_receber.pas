...
procedure TFrm_conta_receber.btn_imprimirClick(Sender: TObject);
var caminho: String;
begin
   caminho := ExtractFilepath(Application.ExeName);
  if Frm_conta_receber.Recibo.LoadFromFile(caminho + 'Rel_recibo_pagamento.fr3') then
  begin
    Recibo.Clear;
    Recibo.LoadFromFile(extractfilepath(application.ExeName) + 'Rel_recibo_pagamento.fr3');
